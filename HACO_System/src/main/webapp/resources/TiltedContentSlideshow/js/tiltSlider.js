...
;( function( window ) {
	...
	TiltSlider.prototype._initEvents = function() {
		var self = this;
		// showT a new item when clicking the navigation "dots"
	...
	TiltSlider.prototype._showTItem = function( pos ) {
		if( this.isAnimating ) {
			return false;
		}
		...
		var cntAnims = 0,
			...
			onEndAnimationCurrentItem = function() {
				++animEndCurrentCnt;
				var endFn = function() {
					classie.removeClass( currentItem, 'hideT' );
			...
			onEndAnimationNextItem = function() {
				++animEndNextCnt;
				var endFn = function() {
					classie.removeClass( nextItem, 'showT' );
		...
		classie.addClass( currentItem, 'hideT' );
		classie.addClass( nextItem, 'showT' );
