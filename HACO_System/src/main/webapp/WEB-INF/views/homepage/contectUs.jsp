...
<script src="${pageContext.request.contextPath}/resources/js/classie.js"></script>
		<script>
			...
			(function() {
				...
				$("#backst").backstretch("${pageContext.request.contextPath}/resources/images/20140819_005048.png");
	    ...
	    function initialize() {
	    	...
	    	var mapOptions = {
				...
				/* var marker = new google.maps.Marker({
	   			...
	   			var size_x = 30;
	   			var size_y = 30;
	   			var image = new google.maps.MarkerImage( '${pageContext.request.contextPath}/resources/favicon.png',  
