...
$(document).ready(function(){
	...
	var submit = function(){
		if($.trim($('input[name=searchKey]').val()).length==0){
			...
			location.href="${pageContext.request.contextPath}/management/notice/pageSize/"+$('input[name=pageSize]').val()+"/pageNum/1/searchType/"+$('input[name=searchType]').val()+"/searchKey/"+$.trim($('input[name=searchKey]').val());
		}
	}
