		...
		<div class="row mt">
			<div class="col-lg-12">
				<div class="form-panel">
					...
					<form class="form-horizontal style-form" action="Register3" id="insertsubject" method="get">
						...
						<div class="form-group">
							...
							<label class="col-md-2 col-sm-2 control-label">교육센터명</label>
							<div class="col-md-4 col-sm-4">
						...
						<div class="form-group">
							...
							<label class="col-md-2 col-sm-2 control-label">총강의시간</label>
							<div class="col-md-4 col-sm-4">
								<input type="text" class="form-control" name="lecture_totaltime">
							</div>
						</div>
