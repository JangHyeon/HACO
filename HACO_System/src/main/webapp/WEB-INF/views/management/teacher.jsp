...
<%@ taglib prefix="s" uri="http://www.springframework.org/security/tags"%>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/assets/css/to-do.css">

	<input id="current-accordion" type="hidden" value="employee,teacher"/>
    ...
    <script src="${pageContext.request.contextPath}/resources/assets/js/tasks.js" type="text/javascript"></script>
