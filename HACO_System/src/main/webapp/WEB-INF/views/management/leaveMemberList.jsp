...
<%@ taglib prefix="s" uri="http://www.springframework.org/security/tags"%>
    ...
    <link href="${pageContext.request.contextPath}/resources/assets/css/table-responsive.css" rel="stylesheet">

	<input id="current-accordion" type="hidden" value="member,leaveMemberList"/>
                      ...
                      <h4><i class="fa fa-angle-right"></i> Responsive Table</h4>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                  <td>ADU</td>
                                  <td>ADAMUS ${pageContext.request.contextPath}/resources LIMITED</td>
                          ...
                          <section id="no-more-tables">
                              <table class="table table-bordered table-striped table-condensed cf">
                                  ...
                                  <tr>
                                      ...
                                      <td data-title="Company">ADAMUS ${pageContext.request.contextPath}/resources LIMITED</td>
