...
<%@ taglib prefix="s" uri="http://www.springframework.org/security/tags"%>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/assets/js/bootstrap-datepicker/css/datepicker.css" />
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/assets/js/bootstrap-daterangepicker/daterangepicker.css" />
	...
	<input id="current-accordion" type="hidden" value="14,15"/>
